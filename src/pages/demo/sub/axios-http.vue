<template>
  <div class="axios-demo">
    ...
    <div class="item demo1">
      ...
      <p class="note">【1】原生axios需添加baseUrl；【2】请将src\api\apiConfig.js的toggleBaseUrl设置为 2 ，【3】并启动server\dev.server.js的Express服务器</p>
    ...
    <div class="item demo2">
      ...
      <p class="note">【1】使用$http不需要额外添加baseUrl；【2】从Express服务器获取数据；【3】请将toggleBaseUrl设置为 2（模拟api地址为/seller）</p>
    ...
    <div class="item demo4">
      ...
      <p class="note">演示Mock.js接口拦截数据--http://text.com</p>
    ...
    <div class="item demo5">
      ...
      <p class="note">【1】演示接口错误的情况【2】从mockjs获取数据, 请将toggleBaseUrl设置为 3</p>
