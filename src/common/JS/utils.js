/*
 * @Description: 本实用方法来自：https://github.com/Michael-lzg/vue-cli4-vant.git
 * @Author: Colin
 * @Date: 2021-01-25 22:32:34
 */

/**
 * @description: 使用说明：
 * @todo 1.引入：import utils from './JS/utils'
 * @todo 2.注册到vue：Vue.use(utils)
 * @example 3.使用示例：this.util.getUrlParams()
 */
export default {
  install (Vue, options) {
    Vue.prototype.util = {
